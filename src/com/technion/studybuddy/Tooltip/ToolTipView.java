...
package com.technion.studybuddy.Tooltip;
		...
		ViewTreeObserver.OnPreDrawListener
{
	...
	private void applyToolTipPosition()
	{
		...
		{
			mTopPointerView.setVisibility(showBelow ? View.VISIBLE : View.GONE);
			mBottomPointerView.setVisibility(showBelow ? View.GONE
					: View.VISIBLE);
		}
		...
		} else
		{
			...
			{
				animators.add(ObjectAnimator.ofInt(this,
						ToolTipView.TRANSLATION_Y_COMPAT, mRelativeMasterViewY
								+ mView.getHeight() / 2 - getHeight() / 2,
						toolTipViewY));
				animators.add(ObjectAnimator.ofInt(this,
						ToolTipView.TRANSLATION_X_COMPAT, mRelativeMasterViewX
								+ mView.getWidth() / 2 - mWidth / 2,
						toolTipViewX));
			} else if (mToolTip.getAnimationType() == ToolTip.AnimationType.FROM_TOP)
				animators.add(ObjectAnimator.ofFloat(this,
						ToolTipView.TRANSLATION_Y_COMPAT, 0, toolTipViewY));

			animators.add(ObjectAnimator.ofFloat(this,
					ToolTipView.SCALE_X_COMPAT, 0, 1));
			animators.add(ObjectAnimator.ofFloat(this,
					ToolTipView.SCALE_Y_COMPAT, 0, 1));

			animators.add(ObjectAnimator.ofFloat(this,
					ToolTipView.ALPHA_COMPAT, 0, 1));
	...
	public void remove()
	{
		...
		} else
		{
			...
			{
				animators.add(ObjectAnimator.ofInt(this,
						ToolTipView.TRANSLATION_Y_COMPAT, (int) getY(),
						mRelativeMasterViewY + mView.getHeight() / 2
								- getHeight() / 2));
				animators.add(ObjectAnimator.ofInt(this,
						ToolTipView.TRANSLATION_X_COMPAT, (int) getX(),
						mRelativeMasterViewX + mView.getWidth() / 2 - mWidth
								/ 2));
			} else
				animators.add(ObjectAnimator.ofFloat(this,
						ToolTipView.TRANSLATION_Y_COMPAT, getY(), 0));

			animators.add(ObjectAnimator.ofFloat(this,
					ToolTipView.SCALE_X_COMPAT, 1, 0));
			animators.add(ObjectAnimator.ofFloat(this,
					ToolTipView.SCALE_Y_COMPAT, 1, 0));

			animators.add(ObjectAnimator.ofFloat(this,
					ToolTipView.ALPHA_COMPAT, 1, 0));
